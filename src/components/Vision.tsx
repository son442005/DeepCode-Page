...
const Vision = () => {
    ...
    return (
        <section id="vision" className=" ">
            <div className="">
                <FadeUp className=" bg-gradient-to-br from-primary/5 to-secondary/10 p-8 rounded-xl">
                    ...
                    <div className="mt-6 text-center">
                        <p className="mx-auto max-w-5xl text-xl sm:text-2xl leading-relaxed font-serif text-slate-800">
                    ...
                    <div className="mt-10 grid gap-8 lg:grid-cols-2">
                        <div className="shadow-3d shadow-3d-hover rounded-[32px] border-2 border-primary/20 bg-white backdrop-blur-sm p-6 sm:p-8 transition-shadow">
                            <h3 className="text-2xl font-serif font-semibold text-secondary">{lang === 'en' ? 'Strategic Directions' : lang === 'vi' ? 'Định Hướng Chiến Lược' : '战略方向'}</h3>
