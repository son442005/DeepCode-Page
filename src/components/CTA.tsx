    ...
    return (
        <section id="contact" className="bg-white rounded-none sm:rounded-3xl -mx-4 sm:-mx-6 md:mx-0">
            <div className="px-4 py-12 sm:px-6 sm:py-14 md:px-8 md:py-16 lg:px-10 lg:py-20">
                <div className="rounded-none sm:rounded-2xl bg-gradient-to-r from-[#FFFFFF] to-[#E9ECEF] p-6 sm:p-8 md:p-10 lg:p-12 shadow">
                    <div className="grid gap-10 lg:grid-cols-2 items-start">
                        ...
                        <form onSubmit={handleSubmit} className="grid gap-5 bg-white rounded-2xl p-6 ring-1 ring-slate-200">
                            ...
                            <button type="submit" className="rounded-lg bg-primary px-5 py-3 font-medium text-white shadow hover:brightness-110 transition">{lang === 'en' ? 'Send request' : lang === 'vi' ? 'Gửi yêu cầu' : '发送请求'}</button>
                        </form>
                    </div>
                </div>
            </div>
